...
# Crypto & SDK Version Hooks (HOS3/HOS4 A15 & A16 Decryption Fix)
...
# Vendor Boot & GKI Kernel 6.6 Module Loading (LKM Support)
...
# Dynamic Module loading config
TW_LOAD_VENDOR_BOOT_MODULES := true
TW_LOAD_VENDOR_MODULES := "touchscreen mtk_disp focaltech_touch goodix_touch"
...
# OrangeFox Framework Configurations
...
# OrangeFox Dynamic Build Variable Hooks
FOX_RECOVERY_SYSTEM_IS_BYOD := 1
FOX_VANILLA_BUILD := 0
FOX_BUGGED_AOSP_DHCP := 1
OF_QUICK_BACKUP_LIST := "/boot;/init_boot;/vendor_boot;"

# init_boot ramdisk (LKM)
...
# Version
TW_DEVICE_VERSION := gold-HOS3-HOS4-GKI
